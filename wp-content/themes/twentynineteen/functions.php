...
function twentynineteen_scripts() {
        wp_enqueue_script('twentynineteen-jquery-min','https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js', array(), '3.3.1', true );
        
        wp_enqueue_script('twentynineteen-jquery-validate','https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.19.0/jquery.validate.min.js', array(), '1.19.0', true );
        
        wp_enqueue_script('twentynineteen-datatables', 'https://cdn.datatables.net/1.10.19/js/jquery.dataTables.min.js', array(), '1.10.19', true );
        
        wp_enqueue_style( 'twentynineteen-datatables', 'https://cdn.datatables.net/1.10.19/css/jquery.dataTables.min.css', array(), '1.10.19' );
	...
	if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
        ...
        wp_enqueue_script( 'twentynineteen-custom-script', get_theme_file_uri( '/js/custom-script.js' ), array(), '1.0', true );
}
