...
if (isset($_POST['signup'])) {
    ...
    if (isset($_POST['mepr_training'])) {
        $user = get_user_by( 'login', $_POST['mepr_training'] );
        $to = $user->email;
        $subject = 'Trainer Selection';
        $body = 'You are selected as a trainer';
        $headers = array('Content-Type: text/html; charset=UTF-8');

        wp_mail( $to, $subject, $body, $headers );
        update_user_meta($operatorId,'mepr_training',$_POST['mepr_training']);
    }
    if (isset($_POST['mepr_evaluation'])) {
        $user = get_user_by( 'login', $_POST['mepr_evaluation'] );
        $to = $user->email;
        $subject = 'Evaluator Selection';
        $body = 'You are selected as a evaluator';
        $headers = array('Content-Type: text/html; charset=UTF-8');

        wp_mail( $to, $subject, $body, $headers );
        update_user_meta($operatorId,'mepr_evaluation',$_POST['mepr_evaluation']);
    }
    ...
    if (is_wp_error($operatorId)) {
        $_SESSION['error'] = $operatorId->get_error_message();
    } else {
                            ...
                            <form class="form-horizontal" id="operator" action="" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="show_training" style="display:none;">
                                        <label class="control-label col-sm-2" for="mepr_training">Trainer Id:</label>
                                        <div class="col-md-12">
                                            <?php
                                                $args = array(
                                                ...
                                                if (!empty($users)) {
                                            ?>
                                            <select class="mepr-form-input " name="mepr_training" id="mepr_training">
                                            ...
                                            ?>
                                            <input type="text" class="mepr-form-input " name="mepr_training" id="mepr_training">
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="show_evaluation" style="display:none;">
                                        <label class="control-label col-sm-2" for="mepr_evaluation">Evaluator Id:</label>
                                        <div class="col-md-12">
                                            <?php
                                                $args = array(
                                                    'meta_key'     => 'mepr_company_name',
                                                ...
                                                if (!empty($users)) {
                                            ?>
                                            <select class="mepr-form-input " name="mepr_evaluation" id="mepr_evaluation">
                                            ...
                                            ?>
                                            <input type="text" class="mepr-form-input " name="mepr_evaluation" id="mepr_evaluation"
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
