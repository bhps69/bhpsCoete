<?php /* Template Name: Operator Profile Creator */ 
 session_start();
...
if (isset($_POST['operator-submit'])) {
    ...
    $wpdb->query("INSERT INTO `experience_table` (`id`, `account_id`, `date`, "
        ...
        . "'".$_POST['mepr_training']."','','".$_POST['mepr_attachment']."','',"
    ...
    if (isset($_POST['mepr_training']) && $_POST['mepr_training'] != '') {
        ...
        $wpdb->query("INSERT INTO `selected_trainer_evaluator` (`id`,`operator_id`,"
            ...
            . "VALUES ('','".$current_user->user_login."','".$_POST['mepr_training']."',"
            . "'0','','','','".$expId."','".date('Y-m-d')."')");
    }
    if (isset($_POST['mepr_evaluation']) && $_POST['mepr_evaluation'] != '') {
        ...
        $wpdb->query("INSERT INTO `selected_trainer_evaluator` (`id`,`operator_id`,"
            . "`trainer_evaluator_id`,`status`,`trainer_evaluator_note`, `operator_note`,"
            . " `certificate`, `experience_id`, `created_at`) "
            . "VALUES ('','".$current_user->user_login."','".$_POST['mepr_evaluation']."','0',''"
            . " ,'','','".$expId."','".date('Y-m-d')."')");
    }
    ...
    <form id="msform" class="col-md-12" method="POST">
        ...
        <fieldset id="step1">
            <div class="col-md-12 form-group">
                <label for="exptype">Select One: <span class="text-red">*</span></label>
                <select name="experience_type" id="exptype">
            ...
            <div class="col-md-6 form-group">
                ...
                <input type="text" class="coete-input " name="mepr_hours" id="mepr_hours">                        
            </div>
            <div class="clearfix"></div>
        ...
        <fieldset id="step2">
            ...
            <div class="col-md-6 form-group">
                ...
                <input type="text" name="mepr_maximum_capacity_tons" id="mepr_maximum_capacity_tons" placeholder="Maximum Capacity in tons" />
            </div>
            <div class="col-md-6 form-group">
            ...
            <div class="mobileCraneType" style="display:none;">
                <div class="col-md-6 form-group">
                    ...
                    <input type="text" name="mepr_main_boom_length" id="mepr_main_boom_length" placeholder="Main Boom Length (ft)" />
                </div>
                <div class="col-md-6 form-group">
                    <label>Jib Length (ft)</label>
                    <input type="text" name="mepr_mjib_length" id="mepr_jib_length" placeholder="N/A" />
                </div>
                <div class="clearfix"></div>
                <div class="col-md-6 form-group">
                ...
                <div class="col-md-6 form-group">
                    ...
                    <input type="text" name="mepr_counterweight" id="mepr_counterweight" placeholder="Fixed" />
                </div>
                <div class="clearfix"></div>
                <div class="col-md-6 form-group">
            ...
            <div class="towerCraneType" style="display:none;">
                <div class="col-md-6 form-group">
                    ...
                    <input type="text" name="mepr_tower_height" id="mepr_tower_height" placeholder="Tower Height (ft)" />
                </div>
                <div class="col-md-6 form-group">
                    <label>Jib Length (ft)</label>
        ...
        <fieldset id="step3">
            ...
            <div class="col-md-12 text-center">
                <input type="button" name="previous" class="previous action-button" value="Previous" />
                <input type="submit" name="operator-submit" class="action-button" value="Save" />
            </div>
            <div class="clearfix"></div>
        </fieldset>
    </form>
