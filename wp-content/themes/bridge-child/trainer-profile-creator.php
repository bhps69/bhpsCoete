<?php /* Template Name: Trainer Profile Creator */
 session_start();
    ...
    <form id="msform" class="col-md-12" method="POST">
        ...
        <fieldset id="step1">
            ...
            <div class="col-md-6 form-group">
                ...
                <input type="text" name="mepr_company_name" id="mepr_company_name" value="<?php echo $company->display_name; ?>" disabled />      
        ...
        <fieldset id="step2">
            ...
            <div class="mobileCraneType" style="display:none;">
                ...
                <div class="col-md-6 form-group">
                    ...
                    <input type="text" name="mepr_mjib_length" value="N/A" placeholder="N/A" />
                </div>
                <div class="clearfix"></div>
                <div class="col-md-6 form-group">
                    <label>Superlift</label>
                    <input type="text" name="mepr_superlift" value="N/A" placeholder="N/A" />
                </div>
                <div class="col-md-6 form-group">
                    <label>Counterweight</label>
                    <input type="text" name="mepr_counterweight" value="Fixed" placeholder="Fixed" />
                </div>
                <div class="clearfix"></div>
                <div class="col-md-6 form-group">
            ...
            <div class="towerCraneType" style="display:none;">
                ...
                <div class="col-md-6 form-group">
                    <label>Jib Length (ft)</label>
                    <input type="text" name="mepr_tjib_length" value="N/A" placeholder="N/A" />
                </div>
                <div class="clearfix"></div>
                <div class="col-md-6 form-group">
                    <label>Controls</label>
        ...
        <fieldset id="step3">
            ...
            <div class="col-md-12 text-center">
                <input type="button" name="previous" class="previous action-button" value="Previous" />
                <input type="submit" name="trainer-submit" class="action-button" value="Save" />
            </div>
            <div class="clearfix"></div>
        </fieldset>
    </form>
