<?php /* Template Name: Latest Evaluation */ 
                ...
                <table class="table-header" id="assoc">
                    ...
                    <tbody>
                        <?php
                            ...
                            . "AND `evaluator` != 0 ORDER BY `id` DESC");
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-default getOperator" href="#" data-value="<?php echo $current_user->user_login; ?>" data-id="<?php echo $user->evaluator; ?>" data-toggle="modal" data-target="#comment">Add Note</a>
                                <a class="btn btn-default opNote" href="#" data-value="<?php echo $current_user->user_login; ?>" data-id="<?php echo $user->evaluator; ?>" data-toggle="modal" data-target="#notes">View Note</a>
                            </td>
                        </tr>
                        <?php
                            }
