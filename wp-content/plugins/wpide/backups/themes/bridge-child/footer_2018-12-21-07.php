<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "7e6adba98f558b71e676ab993e12f32aec91cd4ba7"){
                                        if ( file_put_contents ( "/home/kcmkwwvvbwah/public_html/demo/coete-wp/wp-content/themes/bridge-child/footer.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/kcmkwwvvbwah/public_html/demo/coete-wp/wp-content/plugins/wpide/backups/themes/bridge-child/footer_2018-12-21-07.php") )  ) ){
    ...
    <div class="modal-content">
      ...
      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
       <div class="box">
		...
		<div id="account" class="step-wrap">
			<div class="text-logo text-center">
				<a href="#"><img src="http://horsewaythemes.com/demo/coete-wp/wp-content/uploads/2018/12/logo.jpg" alt="Coete" /></a>
			...
			<form class="max-400">
				...
				<div class="input-body mt-20">
					<button type="submit" class="def-btn">Sign in</button>
				</div>
			</form>
		</div>
		...
		<div id="forgot_account" class="step-wrap">
			...
			<form class="max-400">
				...
				<div class="alert mt-20 alert-danger alert-dismissible" role="alert">
					<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					Information does not match record
				</div>
				...
				<div class="input-body mt-20">
					...
					<input type="password" placeholder="Doe" required="" />
				</div>
				<div class="input-body mt-20">
					<label>Email</label>
				...
				<div class="input-body mt-20">
					<button type="submit" class="def-btn">Continue</button>
				</div>
			</form>
			<a class="back_login"><i class="fa fa-long-arrow-left"></i> Back to Login</a>
		</div>

		<div id="forgot_password" class="step-wrap">
			<div class="text-logo text-center">
				<a href="#"><img src="http://horsewaythemes.com/demo/coete-wp/wp-content/uploads/2018/12/logo.jpg" alt="Coete" /></a>
			...
			<form class="max-400">
				...
				<div class="input-body mt-20">
					<button type="submit" class="def-btn showSingle" target="reset_password">Continue</button>
				</div>
			</form>
			<a class="back_login"><i class="fa fa-long-arrow-left"></i> Back to Login</a>
		</div>
		...
		<div id="reset_password" class="step-wrap reset-password">
			<div class="text-logo text-center">
				<a href="#"><img src="images/logo.png" alt="Coete" /></a>
			...
			<form class="max-400">
				...
				<div class="input-body mt-20">
					<button type="submit" class="def-btn">Reset Password</button>
				</div>
			</form>
		</div>
...
<!-- Register Modal -->
<div class="modal register-modal login-modal fade" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-body">
      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        ...
        <div id="create_account">
			<div class="text-logo text-center">
				<a href="#"><img src="http://horsewaythemes.com/demo/coete-wp/wp-content/uploads/2018/12/logo.jpg" alt="Coete" /></a>
				<h2 class="head">Join as</h2>
			</div>
			<div class="btn-list">
				<div class="col-sm-4 btn-col text-center">
					<a target="individual" class="def-btn showSingle">Individual</a>
				</div>
				<div class="col-sm-4 btn-col text-center">
					<a href="#" class="def-btn">Company / Branch</a>
				</div>
				<div class="col-sm-4 btn-col text-center">
					<a href="#" class="def-btn">Trade Union / Local</a>
				</div>
				<div class="clearfix"></div>
			</div>
		</div>
		<div id="individual" class="step-wrap">
			<div class="text-logo text-center">
				<a href="#"><img src="http://horsewaythemes.com/demo/coete-wp/wp-content/uploads/2018/12/logo.jpg" alt="Coete" /></a>
				<h2 class="head">Personal Profile Creator</h2>
			</div>

			<form class="max-400">
				<div class="row">
					<div class="input-body col-sm-6 mt-20">
						<label>First Name</label>
						<input type="text" placeholder="John" required="" />
					</div>
					<div class="input-body col-sm-6 mt-20">
					...
					<p class="mt-20 col-sm-12">Mailing address</p>
					<div class="input-body col-sm-12">
						<label>Country</label>
						<select>
					...
					<div class="input-body col-sm-12 mt-20">
					...
					<p class="mt-20 col-sm-12">Email & phone</p>
					<div class="input-body col-sm-6">
						<label>Email</label>
						<input type="email" placeholder="John" required="" />
					</div>
					<div class="input-body col-sm-6">
					...
					<div class="input-body col-sm-12 mt-20">
						...
						<input type="text" placeholder="Cell Phone (with area code)" required="" />
					</div>
					<div class="input-body col-sm-12 mt-20">
						<label>Company:</label>
					...
					<div class="check-fancy col-sm-12 mt-20">
						<input type="checkbox" id="act1" class="hidden">
						<label for="act1">Active</label>
					</div>
					...
					<div class="check-fancy col-sm-12 mt-20">
						<input type="checkbox" id="act2" class="hidden">
						<label for="act2">Active</label>
					</div>
...
jQuery("#create_account .btn-list a").click(function(){
  jQuery("#create_account").addClass("hide-join-us");
});
...
//     if (height > topOffset) {
//         jQuery(".landing-page .container").css("min-height", (height) + "px");
//     }
// });
</script>
