...
//				echo "File Uploaded successfully!!!.";
				...
				$q = "INSERT INTO imageupload (image_name,image_path,image_desc,image_width,image_height,image_type,image_mem) VALUES('".$fileName[0]."', '".$path.'"/"'.$bas."' ,'".$desc."', ".$size[0].", ".$size[1].", '".$mime[1]."', ".$mem.")";
//				echo $q;
				$wpdb->query($q);
